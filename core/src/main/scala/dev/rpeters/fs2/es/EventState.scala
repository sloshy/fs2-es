...
trait EventState[F[_], E, A] {
  ...
  /** Feeds a stream of events into this `EventState` and returns the final state. If you don't have a `Concurrent`
...
object EventState {
  ...
  final class EventStatePartiallyApplied[F[_]: Concurrent]() {
    ...
    /** Gives you an `EventState` that is initialized to a starting value and cannot be removed. In the event that an
      * event would otherwise "remove" your state, it keeps the current state value.
      */
    ...
    /** Gives you an `EventState` powered by a user-defined function with a starting value that cannot be removed. The
      * supplied function ensures that you can never remove your state and it must always have a valid value.
      */
...
object EventStateTopic {
  ...
  final class EventStateTopicPartiallyApplied[F[_]: Concurrent]() {
    ...
    /** Gives you an `EventStateTopic` that is initialized to a starting value and cannot be removed. In the event that
      * an event would otherwise "remove" your state, it keeps the current state value.
      */
...
object SignallingEventState {
  ...
  final class SignallingEventStatePartiallyApplied[F[_]: Concurrent]() {
    ...
    /** Gives you a `SignallingEventState` that is initialized to a starting value and cannot be removed. In the event
      * that an event would otherwise "remove" your state, it keeps the current state value.
      */
    ...
    /** Gives you a `SignallingEventState` powered by a user-defined function with a starting value that cannot be
      * removed. The supplied function ensures that you can never remove your state and it must always have a valid
      * value.
      */
